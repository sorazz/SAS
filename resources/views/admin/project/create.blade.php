...
<div class="row">
    <!-- form start -->
    @if (isset($model))
    <form id="form_1" action="{{url('/admin/project/'.$model->id .'/update')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
        @csrf
        @else
        <form id="form_1" action="{{url('/admin/project/store')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
            @csrf
            @endif
            <div class="col-md-8">
                <!-- Horizontal Form -->
