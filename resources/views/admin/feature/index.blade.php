                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table id="sortable" class="table table-striped table-hover todo-list ui-sortable">
                                ...
                                <tbody id="itemList">
                                    @include('admin.feature.list', ['models' => $models])
                                </tbody>
                            </table>
                        </div>
                        <!-- /.box-body -->
    ...
    $(document).ready(function() {
        ...
        function updateTable(items) {
            ...
            $.each(items, function(index, item) {
                ...
                row.append('<td class="item-title"><a href="/admin/feature/' + item.id + '/edit">' + item.title + '</a></td>');
                row.append('<td>' + item.updated_at + '</td>');
                row.append('<td>' + (item.status === 1 ? 'Active' : 'Inactive') + '</td>');
                row.append('<td><a style="margin-right:10px;" href="/admin/feature/' + item.id + '/edit"><i class="fa fa-edit"></i>Edit</a><a href="javascript:void(0);" id="' + item.id + '" class="delete-data delete-item"><i class="fa fa-trash-o"></i>Delete</a></td>');
