...
{
    private $controller = 'admin/testimonial';
    private $rpp = 10; //row per page //default-RPP
    private $title = 'Testimonial';
    private $table = 'testimonial';
    private $sort_by = 'name';
    private $sort_order = 'desc';
    private $listing_page = 'admin.testimonial.index';
    private $create_form = 'admin.testimonial.create';
    private $update_form = 'admin.testimonial.create';
    private $status = [
    ...
    {
        Testimonial::createModel($request);
    ...
    public function update(Request $request, $id)
    {
        ...
        Testimonial::updateModel($request, $id);
    ...
    {
        $affected_models = Testimonial::deleteModel($request);
